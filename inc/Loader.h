...
class Loader
{
   private:
      ...
      bool badData(String l, int ln); //checking for bad data
      void loadToMemory(String l);
      bool isHex(String l, int sIdx);
      bool badComment(String l, int ln);
      bool dataMultOf2(String l);
      bool dataStart(String l);
      bool noAddress(String l);
      bool nonContiguous(String l);
      bool lastAddressLess(String l);
